...
class HeyBotCommand:
    async def handle_hey_bot_command(ctx):
        template = """You are a helpful chat assistant. This is my Discord chat channel, where I host documentation for the Cryptographic API Services Github Organization.
