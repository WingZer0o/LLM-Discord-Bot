...
class HeyBotCommand:
    async def handle_hey_bot_command(ctx):
        ...
        provided to you from the user who is chatting with you, you are to answer questions to the best of your ability. There is such thing as a newbie question, you are to answer them all.
        Question: {question}"""
